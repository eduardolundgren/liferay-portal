...
<table class="aui-table aui-table-bordered aui-table-hover aui-table-striped" width="33%">
<tr>
	<td width="33%">
		<table class="aui-table aui-table-bordered aui-table-hover aui-table-striped" border="0" cellpadding="4" cellspacing="0" width="100%">
			<thead>
